...
* @Last Modified time: 2016-03-19 16:54:14
*/
...
FlowRouter.route('/', {
  ...
  action: function(params, queryParams) {
    var queryString = queryParams.q;
    if (queryString) {
      BlazeLayout.render("layout", {content: "topTenSearch"});
    } else {
...
articleSection.route('/:_order?', {
  ...
  action: function(params, queryParams) {
    var queryString = queryParams.q;
    if (queryString) {
      BlazeLayout.render("layout", {content: "commentsSearch"});
    } else {
